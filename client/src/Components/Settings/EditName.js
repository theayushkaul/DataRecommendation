        ...
        <div>
            ...
            <Modal isOpen={isModalOpen} onClose={closeModal} style={{
                ...
                <form className="flex flex-col mt-6" onSubmit={(e)=>handleSubmit(e)}>
                    ...
                    <input className="focus:outline-none rounded-full px-4 mt-6 text-sm py-1" style={{backgroundColor:"rgba(0,0,0,0.8)"}} type="text" placeholder="Enter your new name..." onChange={(e) => setName(e.target.value)} />
